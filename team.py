...
team2=SoccerTeam("equipe2",[Player("Zizou",OneOneStrategy()),Player("Bravo",GardienStrategy())])
team22=SoccerTeam("equipe2",[Player("Zizou",GardienStrategy()),Player("Bravo",GardienStrategy())])
